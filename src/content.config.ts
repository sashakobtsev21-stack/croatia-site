 ...
 * Опционально, на контракт прочих категорий не влияет (§23). Слаги ↔ en/ru
 ...
 * Слаги ↔ en/ru лейблы в i18n (`regions`). 8 макрорегионов: побережье
 ...
 * Опционально. Слаги ↔ en/ru лейблы в i18n (`razvlTypes`). 5 подкатегорий.
 */
const RAZVL_TYPES = [
 ...
 * для живущих в Хорватии (риелторы, клининг и т.п.). Слаги ↔ en/ru лейблы в i18n
 * (`serviceRubrics`).
 */
...
const articleBase = z.object({
  ...
  /**
   * Туристический регион Хорватии (§7) — фильтр/чип каталога достопримечательностей.
   ...
   * это релевантно. Все поля — строки (гибко: «Вход свободный», «5 €»,
