---
title: 'Zadar to Split: Bus, Car & How Long It Takes'
description: 'Zadar to Split by bus, car or the coastal road. Frequencies, rough euro fares, driving the A1 vs the D8, and why there is no ferry.'
...
cover:
  ...
  alt: 'People watching the sunset from the Zadar waterfront, with the sea and islands on the horizon'
coverCredit: 'Photo: Fred Romero / Wikimedia Commons, CC BY 2.0'
gallery:
  - src: '/images/zadar-to-split-transport/sea-organ.webp'
    alt: "Aerial view of Zadar's Sea Organ steps meeting the Adriatic, with people walking along the promenade"
    credit: 'Photo: dronepicr / Wikimedia Commons, CC BY 2.0'
affiliate:
  - partner: 'localrent'
    label: 'Compare car hire in Zadar or Split'
    position: 'body-end'
  - partner: 'kiwitaxi'
    label: 'Book a private Zadar → Split transfer'
    position: 'body-end'
sources:
  - 'FlixBus (global.flixbus.com/bus-routes/bus-zadar-split) — Zadar–Split fares, daily departures, journey time'
  - 'Arriva Croatia (arriva.com.hr/en-us/bus-zadar-split) — Zadar–Split timetable, stations, fares'
...
|---|---|---|---|---|
| **Bus / coach** | ~1h45–3 h | ~€14–28 | Year-round, 14+ daily | Cost, frequency, no parking |
| **Drive (A1)** | ~1h30–1h45 | fuel + ~€8 toll + car | Anytime | Stops en route, onward travel |
| **Coastal road (D8)** | ~2.5–4 h | fuel, toll-free | Anytime | Scenery, slow travel |
| ~~Ferry / train~~ | — | — | Does not exist on this route | — |

<figure class="figure">
<img src="/images/zadar-to-split-transport/sea-organ.webp" alt="Aerial view of Zadar's Sea Organ steps meeting the Adriatic, with people walking along the promenade" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Most people start this trip from Zadar's waterfront, home to the Sea Organ — but buses leave from the main station a short walk inland, not from the Riva itself. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/zadar-to-split-transport/maslenica-bridge.webp" alt="The arched Maslenica Bridge carrying the A1 motorway over a deep blue channel between karst cliffs, with the Velebit mountains behind" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Heading south from Zadar, the A1 crosses the Maslenica Bridge over the Novsko ždrilo channel, with the Velebit range behind — one of the more dramatic stretches of Croatian motorway. <span class="figure__credit">Photo: Pudelek (Marcin Szala) / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/zadar-to-split-transport/a1-motorway.webp" alt="The A1 motorway running south through karst hills at dusk, with power-line pylons and mist in the valley" width="1280" height="971" loading="lazy" decoding="async" />
<figcaption>The A1 is fast and toll-by-distance — roughly €8 from Zadar to Split for a car. It trades coastal views for speed and gets you there in well under two hours. <span class="figure__credit">Photo: Jos. / Wikimedia Commons, CC BY 3.0</span></figcaption>
</figure>

If you're hiring, a **one-way rental** between Zadar and Split (or picking up at one airport and dropping at the other) is common, though it usually carries a drop-off fee. Our guide to [renting a car in Croatia](/car-rental/renting-a-car-in-croatia/) covers costs, insurance and the cross-border rules in detail.

## Is the coastal road or a ferry worth it?

Two questions come up a lot on this route, so to be clear:

**There is no ferry between Zadar and Split.** Both are major ferry ports, but they connect outward to the islands — Zadar to Ugljan, Dugi Otok and the Kornati; Split to Hvar, Brač, Vis and Korčula — not directly to each other along the coast. A fast coastal catamaran linking them has been floated over the years, but nothing scheduled runs. If you want sea travel in this part of Dalmatia, it's island hopping, not a city-to-city line; our [Croatia ferries guide](/routes/croatia-ferries-guide/) and the [island hopping](/transport/croatia-island-hopping/) guide explain how the boat network actually fits together.
...
Either way it's a short, easy leg by Croatian standards. Once you're in Split, the [Split travel guide](/cities/split-travel-guide/) covers what to see and where to stay, and if you're carrying on to Dubrovnik, our [Split to Dubrovnik transport](/transport/split-to-dubrovnik-transport/) guide takes the story south.

_All prices and times here are planning estimates in euros, not quotes. Bus fares, timetables and motorway tolls change with the season and the operator — confirm current details with the operator or official sources before you travel. Checked July 2026._
