...
description: 'How to visit Krka National Park: the Skradinski Buk falls, Visovac and Roški slap, trails and boats, tickets, seasons and how to get there.'
...
geo:
  ...
  address: 'Krka National Park, Šibenik-Knin County, Croatia'
accessFrom:
  split:
    km: 90
    duration: '~1–1.5 h'
    note: 'By car on the A1 motorway, or by bus to Šibenik then on to Skradin or Lozovac'
  zadar:
    km: 75
    duration: '~1 h'
    note: 'By car on the A1, or by bus via Šibenik'
visit:
  note: 'Tickets are seasonal — the park sells different summer, shoulder and winter tiers, and boats to Visovac and Roški slap are paid separately. Swimming at Skradinski Buk is no longer allowed. Confirm the current ticket price, opening hours and boat schedules on the official npkrka.hr site before you go.'
  checkedAt: 2026-06-22
cover:
  src: '/images/krka-national-park/cover.webp'
  alt: 'The wide Skradinski Buk waterfalls and footbridge at Krka National Park'
coverCredit: 'Photo: Alberto-g-rovi / Wikimedia Commons, CC BY 4.0'
gallery:
  - src: '/images/krka-national-park/roski-slap.webp'
    alt: 'The fan-shaped cascades of Roški slap on the Krka river'
    credit: 'Photo: Harald Hetzner / Wikimedia Commons, CC0'
  - src: '/images/krka-national-park/boat.webp'
    alt: 'A wooden excursion boat moored on the Krka river'
    credit: 'Photo: Fiver, der Hellseher / Wikimedia Commons, CC BY-SA 4.0'
affiliate:
  - partner: 'trip-tours'
...
sources:
  ...
  - 'Croatian Ministry of Culture and Media — protected areas'
draft: false
---
...
<figure class="figure">
<img src="/images/krka-national-park/skradinski-buk.webp" alt="The Skradinski Buk cascades tumbling past a historic stone watermill at Krka" width="1000" height="667" loading="lazy" decoding="async" />
<figcaption>Skradinski Buk drops over seventeen travertine steps past restored stone watermills — the park's signature view. <span class="figure__credit">Photo: Alberto-g-rovi / Wikimedia Commons, CC BY 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/krka-national-park/visovac.webp" alt="Visovac island with its Franciscan monastery on the lake at Krka National Park" width="1280" height="720" loading="lazy" decoding="async" />
<figcaption>Visovac island holds a 15th-century Franciscan monastery, reached only by boat from the Skradinski Buk area. <span class="figure__credit">Photo: Petra-81 / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
|---|---|---|---|
| [Split](/cities/split-travel-guide/) | ~90 km | ~1–1.5 h | A1 motorway to the Šibenik exit, then to Skradin or Lozovac |
...
In short: choose **Krka** if you're based on the Dalmatian coast and want a half-day trip with a single spectacular waterfall and the option of the island monastery; choose **[Plitvice](/attractions/plitvice-lakes-national-park/)** if you want the larger, more varied landscape and don't mind the longer drive and a full day of walking. Many road-trippers between the coast and Zagreb do both, on different days. Neither park allows swimming any more.
...
Krka pairs naturally with a Dalmatian base. It's an easy half-day from [Split](/cities/split-travel-guide/) and slots into a wider coastal trip — see our [Dalmatia coast route from Split to Dubrovnik](/routes/dalmatia-split-to-dubrovnik/) and the full set of [Croatia itineraries](/routes/). For Croatia's other great waterfall park, compare [Plitvice Lakes](/attractions/plitvice-lakes-national-park/); for more natural sights and day-trip ideas, browse the [attractions hub](/attractions/); and for getting around without your own car, the [transport guide](/transport/) covers buses and ferries.

_Ticket prices, opening hours, boat schedules and the rules on swimming change with the season and from year to year — confirm current details on the official park site above before you go._
