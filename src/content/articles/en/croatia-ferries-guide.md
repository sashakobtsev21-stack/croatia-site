---
title: "How Croatia Ferries Work: A Beginner's Guide"
description: 'How Croatia ferries work for first-timers: car ferry vs catamaran, foot vs vehicle, who runs them, the main ports, and how to buy tickets.'
...
cover:
  ...
  alt: 'The Jadrolinija car ferry MF Zadar at sea off the Croatian coast'
coverCredit: 'Photo: Quintin Soloviev / Wikimedia Commons, CC BY 4.0'
gallery:
  - src: '/images/croatia-ferries-guide/split-port.webp'
    alt: 'Ferries and the Croatian flag at the ferry port of Split'
    credit: 'Photo: dronepicr / Wikimedia Commons, CC BY 2.0'
  - src: '/images/croatia-ferries-guide/adriatic-crossing.webp'
    alt: 'View from a ferry crossing the Adriatic between Split and Brač'
    credit: 'Photo: Mark Ahsmann / Wikimedia Commons, CC BY-SA 3.0'
affiliate:
  - partner: 'trip-tours'
  ...
  - partner: 'trip-carhire'
    ...
    position: 'body-end'
sources:
  - 'Jadrolinija (jadrolinija.hr) — national ferry and catamaran operator; FAQ and timetables (checked June 2026)'
  - 'Kapetan Luka / Krilo (krilo.hr) — catamaran operator, sailing schedule (checked June 2026)'
  - 'Ferryhopper — Croatia Ferries 2026 schedules, prices and booking (ferryhopper.com)'
  - 'Visit Croatia (visit-croatia.co.uk) — ferries and Kapetan Luka pages'
  - 'Croatia Week / Croatia Unscripted — 2026 ferry route news and system explainers'
draft: false
---
...
<figure class="figure">
<img src="/images/croatia-ferries-guide/catamaran.webp" alt="The Jadrolinija fast catamaran Olea during a docking trial at Prvić Luka" width="1280" height="720" loading="lazy" decoding="async" />
<figcaption>A modern Jadrolinija fast catamaran — foot passengers only, but quicker than the car ferry and it lands in the town harbour rather than an out-of-town port. <span class="figure__credit">Photo: Mnalis / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
| Weather sensitivity | More stable in rough seas | Cancelled more easily by strong wind |
| Best for | Drivers, longer stays, lots of luggage | Day trips, quick town-to-town hops |
...
<figure class="figure">
<img src="/images/croatia-ferries-guide/cars-loading.webp" alt="Cars parked on the open vehicle deck of a Croatian car ferry" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The open vehicle deck of a car ferry. Only car ferries carry vehicles; on busy summer routes the car space sells out first, so reserve a place if the line allows it. <span class="figure__credit">Photo: pululante / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
- **Split** — the busiest hub by far and the gateway to central Dalmatia: Brač, Hvar, Vis, Šolta and the through-route down to Korčula and Dubrovnik. If you are island hopping, you will almost certainly pass through Split. See our [Split travel guide](/cities/split-travel-guide/).
...
<figure class="figure">
<img src="/images/croatia-ferries-guide/split-port.webp" alt="Ferries and the Croatian flag at the busy ferry port of Split" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The ferry port of Split — Croatia's busiest. In July and August the vehicle lanes here form long before departure; foot passengers have it far easier. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/croatia-ferries-guide/ticket-office.webp" alt="A Jadrolinija ticket sales office on the Croatian coast" width="1280" height="720" loading="lazy" decoding="async" />
<figcaption>A Jadrolinija sales office. For foot-passenger car ferries in spring or autumn you can often buy here on the day; for summer catamarans and vehicles, book ahead. <span class="figure__credit">Photo: IvanaSophie / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
Once you know how the boats work, the next step is stringing islands together. Our guide to [Croatia island hopping](/transport/croatia-island-hopping/) covers the main routes, sample one-week itineraries and which islands to build a trip around, and the [Hvar travel guide](/cities/hvar-travel-guide/) and [Split travel guide](/cities/split-travel-guide/) cover the two ports you are most likely to pass through. For how the ferries fit with buses, trains and driving across the country, see [getting around Croatia](/transport/getting-around-croatia/), and for the busiest coastal leg, [Split to Dubrovnik by bus, ferry, car or transfer](/transport/split-to-dubrovnik-transport/). The [transport hub](/transport/) collects the rest of our getting-around guides.

_Ferry and catamaran timetables, routes and fares change with the season and the operator. The figures here were checked in June 2026 — always reconfirm current details with Jadrolinija, Kapetan Luka (Krilo) and the other operators before you travel._
