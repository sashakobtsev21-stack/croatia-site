---
title: 'Zagreb to Plitvice Lakes: Bus, Tour & Day-Trip Guide'
description: 'Zagreb to Plitvice Lakes by bus, tour or car: travel time, fares in euros, the day-trip timetable, park tickets and how to plan the day.'
...
cover:
  ...
  alt: 'Aerial view of the Great Waterfall at Plitvice Lakes National Park'
coverCredit: 'Photo: dronepicr / Wikimedia Commons, CC BY 2.0'
gallery:
  - src: '/images/zagreb-to-plitvice/plitvice-lakes.webp'
    alt: 'Turquoise terraced lakes and waterfalls at Plitvice'
    credit: 'Photo: Nayeemkhan78 / Wikimedia Commons, CC BY-SA 4.0'
  - src: '/images/zagreb-to-plitvice/autumn-plitvice.webp'
    alt: 'Autumn colours over the lakes and falls at Plitvice'
    credit: 'Photo: OrionCro / Wikimedia Commons, CC BY-SA 4.0'
affiliate:
  - partner: 'trip-tours'
    label: 'Book a Plitvice day tour from Zagreb'
    position: 'body-end'
  - partner: 'trip-carhire'
    label: 'Compare car rental in Zagreb'
    position: 'body-end'
sources:
  - 'Arriva Croatia (arriva.com.hr) — Zagreb–Plitvička Jezera bus line and timetable (checked June 2026)'
  - 'FlixBus (flixbus.com) — Zagreb to Plitvice Lakes route (checked June 2026)'
  - 'Plitvice Lakes National Park official site (np-plitvicka-jezera.hr) — 2026 price list and timed entry'
  - 'Rome2Rio / CheckMyBus — Zagreb–Plitvice connections and journey times'
  - 'Inspired by Croatia — How to get from Zagreb to Plitvice Lakes (2026)'
draft: false
---
...
<figure class="figure">
<img src="/images/zagreb-to-plitvice/zagreb-bus-station.webp" alt="The main bus station Autobusni kolodvor in Zagreb" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Zagreb's main bus station (Autobusni kolodvor) on Avenija Marina Držića — where the Plitvice buses leave from, about 2 km southeast of the old town. <span class="figure__credit">Photo: Silverije / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/zagreb-to-plitvice/plitvice-lakes.webp" alt="Wooden boardwalks over turquoise lakes and waterfalls at Plitvice" width="1000" height="666" loading="lazy" decoding="async" />
<figcaption>The reward at the end of the bus ride: Plitvice's terraced lakes and travertine falls, explored on wooden boardwalks. Arrive early and you get the boardwalks to yourself. <span class="figure__credit">Photo: Nayeemkhan78 / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
The trade-off is flexibility and price. A tour costs more than a bus ticket and runs to a fixed schedule, so you can't linger past the group's departure or pick your own trail freely. But it solves the two things that trip up independent visitors in summer — **the timed park ticket** (tours pre-book it) and **the return bus** (no risk of a full coach passing you by). If you would rather not think about logistics, or you are short on time, a tour is the low-stress choice. You can [book a Plitvice day tour from Zagreb](/go/trip-tours?c=zagreb-to-plitvice) and have the ticket and transport sorted in one go.
...
Two things matter in summer: tickets are **timed-entry** with a one-hour arrival window, and **daily numbers are capped**, so they **sell out** from June through September. **Book online in advance** on the official site, **np-plitvicka-jezera.hr**, which sells at face value with no booking fee — and match your entrance (1 or 2) to the trail you want, since they are about 2.5 km apart. For the trails, the boat and train, and which lettered route to pick, see our full [Plitvice Lakes guide](/attractions/plitvice-lakes-national-park/).

<figure class="figure">
<img src="/images/zagreb-to-plitvice/batinovac-lake.webp" alt="Clear turquoise water of Batinovac lake among the Upper Lakes at Plitvice" width="880" height="660" loading="lazy" decoding="async" />
<figcaption>Batinovac, one of the Upper Lakes — the clear turquoise comes from travertine and the way light catches the mineral-rich water. <span class="figure__credit">Photo: Knowledge2need / Wikimedia Commons, CC0</span></figcaption>
</figure>
...
1. **Catch the 06:45–08:00 bus** from Autobusni kolodvor (buy the ticket the day before). You reach the park around 9–10.
2. **Have your park ticket pre-booked** for a morning slot, entrance matched to your route.
3. **Walk the classic circuit** (route C links the Lower and Upper Lakes with the boat and train) — allow **4–6 hours** at an unhurried pace.
4. **Aim for a mid- to late-afternoon return bus** to Zagreb; check the timetable in advance, because through-buses can be full in peak season.
...
<figure class="figure">
<img src="/images/zagreb-to-plitvice/autumn-plitvice.webp" alt="Autumn colours reflected over the lakes and waterfalls at Plitvice" width="880" height="496" loading="lazy" decoding="async" />
<figcaption>Plitvice in autumn — thinner crowds and gold-and-red forest. Spring brings the fullest, loudest falls; July and August bring the biggest crowds. <span class="figure__credit">Photo: OrionCro / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
Spend time in the capital before or after the lakes — our [Zagreb travel guide](/cities/zagreb-travel-guide/) covers the old town, museums and where to eat. For the park itself, the [Plitvice Lakes guide](/attractions/plitvice-lakes-national-park/) explains the trails, tickets and seasons in detail, and [getting around Croatia](/transport/getting-around-croatia/) sets out how buses, ferries and driving connect the rest of the country. If you are coming from the coast instead, see [how to visit Plitvice from Zagreb or Split without a car](/routes/plitvice-from-split/), and the [transport hub](/transport/) collects our other getting-around guides.

_Bus timetables, fares and park ticket prices change with the season and year to year. The figures here were checked in June 2026 — always reconfirm current bus times with Arriva or FlixBus and ticket prices on np-plitvicka-jezera.hr before you travel._
