 ...
 * иначе en — язык по умолчанию), без автодетекта и редиректов по гео/Accept-Language.
 */
import { ru } from './ru';
import { en } from './en';
import {
...
const dictionaries: Record<Lang, UIDictionary> = { ru, en };
...
/**
 * Префикс пути для языка: en (DEFAULT_LANG) — корень, ru — `/ru`.
