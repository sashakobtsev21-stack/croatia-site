---
title: 'Croatia Island Hopping: Ferries, Catamarans & Routes'
description: 'How to island-hop in Croatia: ferries vs catamarans, the main operators and hubs, whether you can bring a car, buying tickets and sample 7–10 day routes.'
...
cover:
  ...
  alt: 'A blue-and-white Jadrolinija car ferry on the Adriatic off the Croatian coast'
coverCredit: 'Photo: Quintin Soloviev / Wikimedia Commons, CC BY 4.0'
gallery:
  - src: '/images/croatia-island-hopping/vis-komiza.webp'
    alt: 'Aerial view of Komiža harbour on Vis island, with boats and stone houses around the bay'
...
affiliate:
  ...
  - partner: 'trip-transfers'
    ...
    position: 'body-end'
sources:
  - 'Jadrolinija (jadrolinija.hr) — national ferry and catamaran operator'
  - 'Kapetan Luka / Krilo (krilo.hr) — catamaran operator'
  - 'TP Line (tp-line.hr) — catamaran operator'
  - 'G&V Line (gv-line.hr) — catamaran operator'
...
<figure class="figure">
<img src="/images/croatia-island-hopping/catamaran.webp" alt="The Krilo Jet fast passenger catamaran moored in Split harbour" width="1280" height="851" loading="lazy" decoding="async" />
<figcaption>A Kapetan Luka "Krilo" fast catamaran in Split — foot passengers only, but quicker than the car ferry and it lands right in the island towns. <span class="figure__credit">Photo: Ivan T. / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/croatia-island-hopping/zlatni-rat.webp" alt="Aerial view of the Zlatni Rat (Golden Horn) beach spit at Bol on Brač island" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Zlatni Rat ("Golden Horn") at Bol on Brač — the shifting pebble spit that changes shape with the wind, reached by catamaran or car ferry from Split. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
- **Split** — the busiest hub by far and the gateway to central Dalmatia: Brač, Hvar, Vis, Šolta and the through-route to Korčula and Dubrovnik. If you are island hopping, you will almost certainly pass through Split. See our [Split travel guide](/cities/split-travel-guide/).
...
|---|---|---|
| **Hvar** | Split | Glamorous harbour town, Pakleni islets, lavender; see our [Hvar travel guide](/cities/hvar-travel-guide/) |
...
<figure class="figure">
<img src="/images/croatia-island-hopping/korcula.webp" alt="The fortified old town of Korčula on its peninsula, seen from across the water" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Korčula's walled old town sits on a small peninsula and is often called a "little Dubrovnik" — reached from Split or Dubrovnik on the through-catamaran. <span class="figure__credit">Photo: lienyuan lee / Wikimedia Commons, CC BY 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/croatia-island-hopping/mljet.webp" alt="The islet of St Mary with its monastery on the saltwater Veliko Jezero lake in Mljet National Park" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The islet of St Mary and its monastery on the larger saltwater lake of Mljet National Park, off Dubrovnik. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
**Central Dalmatia loop (about 7 days), from Split, no car.** Base yourself on the Split–Hvar–Korčula spine. Start in [Split](/cities/split-travel-guide/) (1–2 nights), catamaran to **Hvar** (2 nights — town, the fortress, a Pakleni islands boat trip), then continue down the through-catamaran to **Korčula** (2 nights — old town, vineyards), and either loop back to Split or carry on to [Dubrovnik](/cities/dubrovnik-travel-guide/). Slot in a day trip to **Brač** for Zlatni Rat if you have time.

**South to north, one way (about 10 days).** Begin in **Dubrovnik**, take a boat to **Mljet** (1–2 nights in the national park), join the through-catamaran up to **Korčula**, then **Hvar**, then **Split** — adding a side trip to **Vis** from Split for its quieter, end-of-the-line feel. This open-jaw plan pairs well with the road route in our [Dalmatia coast guide from Split to Dubrovnik](/routes/dalmatia-split-to-dubrovnik/) if you mix boat and car.
...
New to the boats? Start with our beginner's guide to [how Croatia ferries work](/routes/croatia-ferries-guide/) — car ferry vs catamaran, reservations and tickets. Then pair this with the islands and cities themselves: [Hvar](/cities/hvar-travel-guide/), [Split](/cities/split-travel-guide/) and [Dubrovnik](/cities/dubrovnik-travel-guide/), and the coastal drive that links them in our [Dalmatia route from Split to Dubrovnik](/routes/dalmatia-split-to-dubrovnik/). If you are combining boats with driving, read [renting a car in Croatia](/car-rental/) first, and for timing your trip, [the best time to visit Croatia](/planning/best-time-to-visit-croatia/). For how the boats fit with buses, trains and driving across the country, see [getting around Croatia](/transport/getting-around-croatia/); and for the busiest coastal leg, [Split to Dubrovnik by bus, ferry, car or transfer](/transport/split-to-dubrovnik-transport/). The [transport hub](/transport/) collects our other guides to getting around.

_Ferry and catamaran timetables, routes and fares change with the season and the operator — always confirm current details with Jadrolinija, Kapetan Luka, TP Line and G&V Line before you travel._
