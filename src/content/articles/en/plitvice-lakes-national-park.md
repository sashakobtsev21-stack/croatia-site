...
description: "How to visit Plitvice Lakes: the 16 cascading lakes, the lettered trails, Veliki Slap, the boat and train, tickets, seasons and how to get there."
...
geo:
  ...
  address: 'Plitvička Jezera, Lika-Senj County, Croatia'
accessFrom:
  zagreb:
    km: 135
    duration: '~2–2.5 h'
    note: 'By car on the A1 motorway then the D1, or by direct intercity bus from Zagreb'
  split:
    km: 250
    duration: '~3.5–4 h'
    note: 'By car on the A1, or by bus; many travellers stop here between Zagreb and the coast'
visit:
  note: 'Timed entry tickets are sold online for a chosen entrance (1 or 2) and time slot, and sell out in summer; the boat and panoramic train are included in the ticket. Prices and hours are strongly seasonal — confirm the current ticket, opening times and any timed-entry rules on the official np-plitvicka-jezera.hr site before you go.'
  checkedAt: 2026-06-22
cover:
  src: '/images/plitvice-lakes-national-park/cover.webp'
  alt: 'Aerial view of the Lower Lakes and travertine waterfalls at Plitvice Lakes National Park'
coverCredit: 'Photo: dronepicr / Wikimedia Commons, CC BY 2.0'
gallery:
  - src: '/images/plitvice-lakes-national-park/clear-water.webp'
    alt: 'Crystal-clear turquoise water over travertine rock at a Plitvice spring'
    credit: 'Photo: dronepicr / Wikimedia Commons, CC BY 2.0'
  - src: '/images/plitvice-lakes-national-park/cascades.webp'
    alt: 'A wide travertine waterfall in the Lower Lakes with visitors above it'
    credit: 'Photo: Dennis G. Jarvis / Wikimedia Commons, CC BY-SA 2.0'
  - src: '/images/plitvice-lakes-national-park/upper-lakes.webp'
    alt: 'A calm forested upper lake at Plitvice on a clear day'
    credit: 'Photo: Dennis G. Jarvis / Wikimedia Commons, CC BY-SA 2.0'
affiliate:
  - partner: 'trip-tours'
...
sources:
  ...
  - 'UNESCO World Heritage List — Plitvice Lakes National Park (whc.unesco.org)'
draft: false
---
...
<figure class="figure">
<img src="/images/plitvice-lakes-national-park/clear-water.webp" alt="Crystal-clear turquoise water over travertine rock at a Plitvice spring" width="1000" height="666" loading="lazy" decoding="async" />
<figcaption>The water's clarity and colour come from dissolved minerals and the white travertine bed — it shifts from turquoise to deep green with the light. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
| Route | Best for | Rough length | Notes |
|---|---|---|---|
| A | Lower Lakes only, short visit | ~2–3 h | From Entrance 1; the Veliki Slap and lower cascades on foot |
| B | Lower Lakes + short boat | ~3–4 h | Adds the electric boat across Lake Kozjak |
| C | The classic full circuit | ~4–6 h | Lower + Upper Lakes, with boat and train — the most popular |
| E / F / H / K | Upper Lakes / longer loops | ~2–6 h | Start from Entrance 2 or cover the whole park |
...
<figure class="figure">
<img src="/images/plitvice-lakes-national-park/veliki-slap.webp" alt="Aerial view of a wide multi-strand waterfall over travertine at Plitvice" width="1000" height="666" loading="lazy" decoding="async" />
<figcaption>Water threads down the travertine cliffs in dozens of strands — the Lower Lakes gorge is the park's most dramatic stretch. <span class="figure__credit">Photo: dronepicr / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/plitvice-lakes-national-park/electric-boat.webp" alt="A panoramic electric ferry on calm Lake Kozjak at Plitvice Lakes" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The electric boats glide across Lake Kozjak between the Upper and Lower Lakes — the ride is part of your ticket. <span class="figure__credit">Photo: Zysko serhii / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
|---|---|---|---|
| [Zagreb](/cities/zagreb-travel-guide/) | ~135 km | ~2–2.5 h | A1 motorway then D1; frequent direct buses |
| [Split](/cities/split-travel-guide/) | ~250 km | ~3.5–4 h | A1 motorway; buses and tours run daily |
| Zadar | ~120 km | ~1.5–2 h | The nearest coastal city; the closest airport for a day trip |

**By car** is the most flexible option — there is large paid parking at both entrances — and lets you arrive before the day-tour buses. If you don't want to drive, see our guide to [renting a car in Croatia](/car-rental/) for what it costs and how the one-way and cross-border rules work. **By bus**, intercity coaches from Zagreb, Zadar and Split stop on the main road by the entrances; check timetables in advance, as some are seasonal. **On a tour**, day trips run from Zagreb, Zadar, Split and Trogir and bundle the transport and ticket together — the simplest choice if you have no car. For the full breakdown of getting here from the capital, see our [Zagreb to Plitvice guide](/transport/zagreb-to-plitvice/).

<figure class="figure">
<img src="/images/plitvice-lakes-national-park/upper-lakes.webp" alt="A calm forested upper lake at Plitvice on a clear day" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The Upper Lakes are broader and quieter than the Lower Lakes gorge — wrapped in beech and fir forest. <span class="figure__credit">Photo: Dennis G. Jarvis / Wikimedia Commons, CC BY-SA 2.0</span></figcaption>
</figure>
...
Plitvice pairs naturally with a Croatia road trip. It's an easy stop between the capital, [Zagreb](/cities/zagreb-travel-guide/), and the coast at [Split](/cities/split-travel-guide/), and slots neatly into a longer drive south — see our [Dalmatia coast route from Split to Dubrovnik](/routes/dalmatia-split-to-dubrovnik/) and the wider [Croatia itineraries](/routes/). For more natural sights and day-trip ideas, browse the [attractions hub](/attractions/), and for getting around without your own car, the [transport guide](/transport/) covers buses and ferries.

_Ticket prices, opening hours and which routes and shuttles are running change with the season — confirm current details on the official park site above before you go._
