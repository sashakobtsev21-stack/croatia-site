---
title: 'Split Airport Transfers: Bus, Ferry & Taxi to City Centre'
description: 'Split Airport (SPU) to the city centre: shuttle bus, public bus, taxi, private transfer, the seasonal catamaran and car hire — rough costs and times.'
...
cover:
  ...
  alt: 'The bright modern interior of the new Split Airport terminal with a departures sign'
coverCredit: 'Photo: SPQST / Wikimedia Commons, CC BY-SA 4.0'
gallery:
  - src: '/images/split-airport-to-city/terminal-forecourt.webp'
    alt: 'The forecourt and car park outside Split Airport terminal in the evening'
    credit: 'Photo: Wistula / Wikimedia Commons, CC BY-SA 4.0'
affiliate:
  - partner: 'kiwitaxi'
  ...
  - partner: 'trip-carhire'
    ...
    position: 'body-end'
sources:
  - 'Split Airport (split-airport.hr) — location, ground transport'
  - 'Promet Split (promet-split.hr) — city bus services Kaštela / Trogir'
  - 'Pleso prijevoz / Croatia Airlines airport shuttle bus — Split'
  - 'Croatian National Tourist Board (croatia.hr) — distances'
draft: false
---
...
<figure class="figure">
<img src="/images/split-airport-to-city/terminal-forecourt.webp" alt="The forecourt and car park outside Split Airport terminal lit up in the evening" width="1280" height="720" loading="lazy" decoding="async" />
<figcaption>Everything — buses, taxis and car-hire desks — sits right outside the terminal at Resnik, between Split and Trogir. <span class="figure__credit">Photo: Wistula / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/split-airport-to-city/shuttle-bus.webp" alt="A Croatia Airlines shuttle coach waiting outside the lit Split Airport terminal at night" width="1280" height="720" loading="lazy" decoding="async" />
<figcaption>The Pleso / Croatia Airlines shuttle coach links the terminal directly with Split's main bus station by the harbour. <span class="figure__credit">Photo: Wistula / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
- **Sort data on arrival.** A working SIM or eSIM makes booking a ride, checking the bus app and finding your accommodation far less stressful — see our wider [getting around Croatia](/transport/getting-around-croatia/) guide for the on-the-ground basics.
...
Once you're in town, the [Split travel guide](/cities/split-travel-guide/) covers what to see and do, and our [getting around Croatia](/transport/getting-around-croatia/) guide explains buses, ferries and trains for the rest of your trip. Heading down the coast next? See [Split to Dubrovnik: bus, ferry, car or transfer](/transport/split-to-dubrovnik-transport/).

_Fares, taxi rates and timetables here are planning estimates in euros, not quotes, and seasonal services change year to year — confirm current details with the operator, the airport or official sources before you travel._
